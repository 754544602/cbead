var mal = {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$.each(datas, function(i, n) {
					var value=n.value;
					if(value!='CHANGE_APP'&&value!='FINAL_APP'){
	...
	formTypeUpdata: function(type,id, fun) {
		...
		switch(type) {
			case 'ADVANCE_APP':
				//事前申请 advanceId
				window.location.href = $yt_option.websit_path +'view/system-sasac/expensesReim/module/busiTripApply/serveApply.html?advanceId='+id;
				break;
			case 'LOAN_APP':
				//借款申请 loanId
				window.location.href = $yt_option.websit_path +'view/system-sasac/expensesReim/module/loanApply/loanApply.html?loanId='+id;
				break;
			case 'REIM_APP':
				//报销申请 reimId
				window.location.href = $yt_option.websit_path +'view/system-sasac/expensesReim/module/reimApply/serveFunds.html?reimId='+id;
				break;
			case 'PAYMENT_APP':
				//付款申请 payAppId
				window.location.href = $yt_option.websit_path +'view/system-sasac/expensesReim/module/payment/paymentApply.html?payAppId='+id;
				break;
			case 'EXPENDITURE_APP':
				//支出申请 payAppId
				var systemId=$yt_common.GetQueryString("systemId");
				var menuId=$yt_common.GetQueryString("menuId");
				window.location.href = $yt_option.websit_path +'view/system-sasac/expensesReim/module/reimApply/expenseAccount.html?appId='+id+"&systemId="+systemId+"&menuId="+menuId;
				break;
			case 'FINAL_APP':
				window.location.href = $yt_option.websit_path + 'view/system-sasac/expensesReim/module/finalApply/finalAccount.html?appId=' + id;
				break;	
			case 'CHANGE_APP':
				//事申请 payAppId
				window.location.href = $yt_option.websit_path +'view/system-sasac/expensesReim/module/busiTripApply/projectServeApply.html?appId='+id;
				break;

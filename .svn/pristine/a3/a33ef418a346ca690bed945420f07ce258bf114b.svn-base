var teacher = {
	...
	init: function() {
		...
		$('.teacher-tbody').on('click','.teacher-name',function(){
			...
			window.location.href = "teacherApprovalInf.html?processInstanceId=" + processInstanceId+"&pkId="+pkId+"&backPage="+1;
		});
	},
	...
	getPlanListInfo: function() {
		...
		$('.list-page').pageInfo({
			...
			pageNum: 15, //每页显示条数  
			pageSize: 10, //显示...的规律  
			url: $yt_option.base_path + "teacher/lookForAllByMy", //ajax访问路径  

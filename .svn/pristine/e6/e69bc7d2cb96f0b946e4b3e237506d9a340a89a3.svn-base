					...
					if(datas.length > 0){
						...
						$.each(datas,function(i,n) {
							trStr += '<tr>'+
								...
								'<td style="text-align: right;">'+ $yt_baseElement.fmMoney(n.totalAmountNow) +'</td>'+
								'<td style="text-align: right;">'+ $yt_baseElement.fmMoney(n.adjustmentAmount) +'</td>'+
								'<td>'+ n.adjustmentNum +' 次</td>'+
								'<td>'+ n.applicantUserName +'</td>'+
								'<td>'+ n.newAdvanceTime +'</td>'+
								'</tr>';
						});

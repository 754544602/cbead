...
//					pageUrl = "view/projectManagement-sasac/expensesReim/module/print/InvoicePasting.html?appId=" + thisTrData.expenditureAppId;
//				}
				//打印支出凭单
...
//					pageUrl = "view/projectManagement-sasac/expensesReim/module/print/expenditureVoucherDetailed.html?expenditureAppId=" + thisTrData.expenditureAppId + '&costType='+thisTrData.costType;
//				}
...
//			window.location.href=$yt_option.websit_path+'view/projectManagement-sasac/expensesReim/module/payment/budgetAuditReduce.html';
		...
		$('.pending1,.pending2').on('click', '.apprv-btn', function(){
			...
			if(taskKey == 'activitiStartTask'){
				//修改
				var pageUrl = "view/projectManagement-sasac/expensesReim/module/finalApply/finalAccount.html?appId="+ advanceAppId +"&fun=" + fun;//即将跳转的页面路径

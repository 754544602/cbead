var paymentRequest = {
	...
	events: function() {
		...
		$('.export-excel').on('click',function(){
			...
			var urlStr = $yt_option.base_path + 'sz/expenditureApp/exportExpenditureInfoListToPageByParams?queryParams=' + queryParams + '&startDate=' + startDate + '&endDate=' + endDate + '&property=' + property + '&direction=DESC' +"&yitianSSODynamicKey="+yitianSSODynamicKey+"&ajax=1";

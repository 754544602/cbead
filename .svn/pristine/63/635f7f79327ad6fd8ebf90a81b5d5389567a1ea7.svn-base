...
//					pageUrl = "view/system-sasac/expensesReim/module/print/InvoicePasting.html?appId=" + serveFinal.appId;
//				}
				//打印决算单
				if($(this).val() == "printExpend") {
					pageUrl = "view/system-sasac/expensesReim/module/print/finalStatement.html?finalAppId=" + serveFinal.appId+"&costType="+serveFinal.costType;
				}
				//打印支出凭单明细
//				if($(this).val() == "printExpendDetail") {
//					pageUrl = 'view/system-sasac/expensesReim/module/print/finalVoucherDetailed.html?finalAppId=' + serveFinal.appId+"&costType="+serveFinal.costType;
//				}

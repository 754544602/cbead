				...
				.on(
						...
						function() {
							...
							if (taskKey == 'activitiStartTask') {
								var pageUrl = "view/system-sasac/expensesReim/module/busiTripApply/projectServeApply.html?appId="
										+ advanceAppId;
								window.location.href = $yt_option.websit_path
										+ pageUrl
							} else {
								var pageUrl = "view/system-sasac/expensesReim/module/busiTripApply/projectServeExamine.html?appId="
										+ advanceAppId;
								window.location.href = $yt_option.websit_path
										+ pageUrl
							}
		...
		$('.pending')
				.on(
						...
						function() {
							...
							var pageUrl = "view/system-sasac/expensesReim/module/beforehand/beforeApplyDetail.html?advanceId="
									+ advanceAppId;
		...
		$('.pending')
				.on(
						...
						function() {
							...
							var processInstanceId = thisTr.find(
									".processInstanceId").val();
							var pageUrl = "view/system-sasac/expensesReim/module/busiTripApply/projectServeDetails.html?advanceAppId="
									+ advanceAppId;
							$yt_baseElement.openNewPage(2, pageUrl)
						});
				...
				.click(
						function() {
							...
							if (selTrLen == 0) {
								...
								var pageUrl = "view/system-sasac/expensesReim/module/print/bugetAdjustApplyForm.html?expenditureAppId="

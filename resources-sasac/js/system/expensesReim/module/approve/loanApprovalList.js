...
//						          	trStr += '<td>'+(n.isSettle == 1 ? "已清账" : "未清账")+'<input type="hidden" class="hid-isSettle" value="'+n.isSettle+'"/></td>';
									trStr += '<td style="text-align: right;">'+$yt_baseElement.fmMoney(n.arrearsAmount)+'<img src="../../../../../resources-sasac/images/common/loanIcon.png" class="account log-loan" style="width: 18px;height: 18px;" />'+'</td>'
						          }else{

...
//			});
		...
		events: function() {
			...
			$("#printUpdateForm").click(function(){
				var pageUrl = "view/system-sasac/expensesReim/module/print/bugetAdjustApplyForm.html?expenditureAppId="+serveExamine.appId+ '&costType='+me.saveData.advanceCostType;//即将跳转的页面路径
				//调用公用的打开新页面方法传输参数不需要左侧菜单
				$yt_baseElement.openNewPage(2,pageUrl);
			});
			 //编辑页面跳转
	        $("#projectServeEdit").on("click",function(){
				 //即将跳转页面
				var pageUrl=$yt_option.websit_path+'view/projectManagement-sasac/expensesReim/module/busiTripApply/projectServeApply.html?appId='+serveExamine.appId;
				//调用公用的跳转方法

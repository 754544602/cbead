(function($, window) {
	var serveExamine = {
		...
		setCostTeachersLectureApplyInfoList: function(list) {
			...
			$('#lectureFeeTable tbody .costTotal-after').text(serveExamine.fmMoney(totalAfter));
			//课酬费税金
			var payTaxes=serveExamine.fmMoney(total-totalAfter);

var loanApply={
	...
	events: function() {
		...
		$("#closeBtn").click(function(){
		  ...
		  //编辑页面跳转
        $("#loanEdit,#loanApplyBtn").on("click",function(){
			 //即将跳转页面
			var pageUrl=$yt_option.websit_path+'view/system/expensesReim/module/loanApply/loanApply.html?loanId='+loanApply.loanId;
			//调用公用的跳转方法
        ...
        $("#printingLoanBtn").on("click",function(){
			 //即将跳转页面
			var pageUrl = "view/system/expensesReim/module/print/printLoanApply.html?loanId=" + loanApply.loanId;
